...
const faqs = [
  {
    ...
    a: 'Within 24 hours of payment you\'ll receive a confirmation email with next steps. Work begins immediately after scoping is confirmed.',
  },
  {
...
const FAQSection: React.FC = () => {
  ...
  return (
    <section
      ...
      className="scroll-animate relative z-0 py-12 border-t border-[#334155]"
    ...
    >
      <div className="w-full px-4 md:px-6">
        <div className="mb-8 text-left">
          ...
          <h2 id="faq-heading" className="text-[2.5rem] sm:text-3xl md:text-5xl lg:text-7xl font-bold text-slate-100 tracking-tight mb-3" style={{ letterSpacing: '-0.06em' }}>
            Frequently Asked{' '}
