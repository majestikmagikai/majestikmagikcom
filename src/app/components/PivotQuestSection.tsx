      ...
      <div className="w-full relative px-4 md:px-6 mx-auto z-20">
        <div className="text-center mx-auto mb-8 md:mb-16 max-w-3xl">
          ...
          <h2
            ...
            className="mb-2 text-[2.75rem] sm:text-5xl md:text-7xl xl:text-8xl text-slate-900 font-bold tracking-tight"
          ...
          <p id="pivot-quest-desc" className="mt-4 text-base md:text-lg text-slate-600 font-sans leading-relaxed">
        ...
        <div className="flex justify-center">
          <div className="services-card-hover-animate flex flex-col items-center text-center max-w-md rounded-lg bg-white border border-slate-300 p-6 md:p-8 shadow-[0_4px_24px_rgba(0,0,0,0.1)] hover:border-indigo-500 hover:shadow-[0_4px_32px_rgba(67,56,202,0.15)] transition duration-200">
