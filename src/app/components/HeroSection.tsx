  ...
  return (
    <section id="home" aria-labelledby="home-heading" className="relative z-0 pt-32 pb-24 md:pt-48 md:pb-36 overflow-hidden bg-[#07080e]">
      ...
      <div
        ...
        style={{
          backgroundImage: 'radial-gradient(rgba(241, 245, 249, 0.3) 1.2px, transparent 1.2px)',
      ...
      <div className="container relative px-6 mx-auto z-20 max-w-5xl text-center">
        ...
        <div
          className="w-full max-w-4xl mx-auto scroll-animate relative"
          style={{ transitionDelay: "1.2s ease-in-out" }}
        >
          {/* Dynamic Aurora Ambient Glow Wrapper (Fades in/out behind the mockup) */}
          <div className="absolute -inset-4 bg-gradient-to-r from-indigo-500/30 via-purple-600/20 to-indigo-500/30 rounded-3xl blur-3xl opacity-75 animate-[pulse_6s_ease-in-out_infinite] pointer-events-none z-0" />
          ...
          <div className="group relative z-10 border border-indigo-500/30 rounded-2xl overflow-hidden shadow-[0_0_50px_rgba(99,102,241,0.15)] bg-indigo-950/20 p-2.5 backdrop-blur-md transition-all duration-500 hover:border-indigo-400/60 hover:shadow-[0_0_60px_rgba(99,102,241,0.35)] animate-[fadeInDown_2.8s_cubic-bezier(0.16,1,0.3,1)_both]">
            ...
            <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-indigo-500/10 to-white/5 pointer-events-none z-30" />
              ...
              <Image
                ...
                width={1000} // Set higher base width for crisp quality
                height={625}
                priority
